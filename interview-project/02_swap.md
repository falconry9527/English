...
二. 过程 :
核心： 每单位流动性 累计手续费= 交易手续费/池子总流动性
场景:假如发生了一个交易：交易产生  手续费 Fee :

1.实时更新 ： 池子 每单位流动性 累计手续费 :
totalFee=totalFeeOld + Fee/ 池子总流动性

每单位流动性 累计手续费 , 避免了池子流动性变化的干扰

2.定时更新 ： LP新增的手续费 :
a. LP新增的手续费 = （池子最新 每单位流动性 累计手续费 totalFee- 用户 每单位流动性 累计手续费 的userFee） * LP提供的流动性
